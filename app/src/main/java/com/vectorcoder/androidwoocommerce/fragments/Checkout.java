    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /*
        ...
        FacebookPixel.logCheckout(logger,getString(R.string.checkout),"","checkout",
                ConstantValues.CURRENCY_SYMBOL,""+checkoutItemsList.size(),checkoutTotal);
        ...
        checkout_webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                if (url.contains(ORDER_RECEIVED)) {
                    ...
                    FacebookPixel.logPurchase(logger,"","Order Placed",ConstantValues.CURRENCY_SYMBOL,""+checkoutItemsList.size(),checkoutTotal);
                    // Clear User's Cart
                    My_Cart.ClearCart();
